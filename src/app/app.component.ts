...
import { AngJsoneditorComponent, JsonEditorOptions } from 'projects/ang-jsoneditor/src/public-api';
...
export class AppComponent {
  ...
  public showData: { randomNumber: number; products: { name: string; product: { name: string; model: { id: string; name: string; }[]; }[]; }[]; };

  public EditedData: string;

  public show = false;

  @ViewChild('editor', { static: false }) editor: AngJsoneditorComponent;
  @ViewChild('editorTwo', { static: false }) editorTwo: AngJsoneditorComponent;

  public form: { value: any; };
  ...
  changeLog(event = null) {
    ...
    if (errors && errors.length > 0) {
      ...
      this.showData = this.editor.get() as any;
    }
  }
  ...
  initEditorOptions(editorOptions: JsonEditorOptions) {
