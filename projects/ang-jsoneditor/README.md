...
```html
<ng-json-editor [options]="editorOptions" [data]="data" (change)="getData($event)"></ng-json-editor>
```
...
```ts
import { AngJsoneditorModule } from 'ang-jsoneditor-13' 
...
import { AngJsoneditorComponent, JsonEditorOptions } from 'ang-jsoneditor-13';

@Component({
  selector: 'app-root',
  template: '<ng-json-editor [options]="editorOptions" [data]="data"></ng-json-editor>',
...
<form  [formGroup]="form" (submit)="submit()">
    <ng-json-editor [options]="editorOptions2" formControlName="myinput">
    </ng-json-editor>
</form>
```
...
```html
<ng-json-editor class="col-md-12" #editorExample style="min-height: 300px;" [options]="editorOptionsData" [data]="dataStructure"></ng-json-editor>
```
...
```html
<ng-json-editor [debug]="true" [options]="editorOptionsData" [data]="dataStructure"></ng-json-editor>
```
...
<div *ngFor="let prd of data.products" class="w-100-p p-24" >
  <ng-json-editor [options]="makeOptions()" [data]="prd" (change)="showJson($event)"></ng-json-editor>
</div>
```
